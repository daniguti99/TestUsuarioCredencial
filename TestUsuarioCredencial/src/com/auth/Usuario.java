...
public class Usuario {
	...
	private Credencial credencial; // Hacemos relacion entre usuario y credencial
	...
	public Usuario(String nombre, String apellido, String password) {
		...
		this.credencial = new Credencial(nombre, apellido, password); //Inicializamos la credencial
	}
	
	public Usuario(String nombre, String apellido, String email, String password) {
		this(nombre, apellido, password); //Llama al constructor que no tiene el email para no volver a repetir y reducir código
	...
	public void mostrarInformacion() { 
		if(esCuentaBloqueada()) {
			...
			System.out.println("Usuari@: " + this.nombre + " " + this.apellido + " con email " + this.email + ", username " + credencial.getUsername() + " y contraseña " + "*".repeat(credencial.getPassword().length()));
